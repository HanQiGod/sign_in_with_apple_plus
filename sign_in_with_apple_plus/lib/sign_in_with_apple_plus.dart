export 'package:sign_in_with_apple_plus_platform_interface/sign_in_with_apple_plus_platform_interface.dart'
    show
...
export './src/sign_in_with_apple_plus.dart' show SignInWithApple;
export './src/widgets/apple_logo_painter.dart' show AppleLogoPainter;
export './src/widgets/sign_in_with_apple_plus_builder.dart'
    show SignInWithAppleBuilder;
export './src/widgets/sign_in_with_apple_plus_button.dart'
    show
