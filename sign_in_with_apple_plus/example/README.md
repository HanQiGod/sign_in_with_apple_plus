# sign_in_with_apple_plus_example

Demonstrates how to use the sign_in_with_apple_plus plugin.
...
adb shell am start -a android.intent.action.VIEW \
    ...
    -d "signinwithapple://callback?code=abc123" com.aboutyou.dart_packages.sign_in_with_apple_plus.example
```
...
adb shell am start -a android.intent.action.VIEW \
    -c android.intent.category.BROWSABLE \
    -d "siwa-example://siwa.example.com/foo" com.aboutyou.dart_packages.sign_in_with_apple_plus.example
```
