...
- Bump `sign_in_with_apple_plus_web` dependency to _actually_ include fix from [#432](https://github.com/aboutyou/dart_packages/pull/432)
...
- Upgrade `sign_in_with_apple_plus_platform_interface` to `1.1.0`
- Upgrade `sign_in_with_apple_plus_web` to `2.1.0`
...
- Switch to `sign_in_with_apple_plus_platform_interface` in conjunction with the addition of web support
